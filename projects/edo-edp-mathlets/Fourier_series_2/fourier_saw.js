...
async function initPyodideAndModule() {
  ...
  // expects: ../../../assets/mathlets/fourier-saw.py
  await loadPythonFile(py, "../../../assets/mathlets/fourier_saw.py");
}
...
async function redraw() {
  try {
    ...
    const xMin = py.runPython("X_MIN");
    const xMax = py.runPython("X_MAX");

    const layout = {
      template: "plotly_dark",
      margin: { l: 55, r: 10, t: 10, b: 55 },
      xaxis: { range: [xMin, xMax], title: "x", showgrid: true, gridcolor: "#444" },
