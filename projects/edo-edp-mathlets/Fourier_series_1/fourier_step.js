...
async function initPyodideAndModule() {
  ...
  // ../../../assets/mathlets/fourier-step.py
  await loadPythonFile(py, "../../../assets/mathlets/fourier_step.py");
}
...
async function redraw() {
  try {
    ...
    const layout = {
      ...
      xaxis: { range: [py.runPython("X_MIN"), py.runPython("X_MAX")], title: "x", showgrid: true, gridcolor: "#444" },
